...
public class LowBackup extends SequentialCommandGroup {

  public LowBackup(SwerveDrive swerve, Intake intake, UpperIndex index, Shooter shooter) {
   ...
   // addCommands(new InstantCommand(() -> swerve.resetPosition(new Pose2d(new Translation2d(0.0,0.0), new Rotation2d(0)))));
    ...
    var shooting = new InstantCommand(() ->new LowShooterCommand(shooter, true));
